...
<head>
	...
	<!--[if lt IE 9]>
		<script src="<?php echo get_template_directory_uri(); ?>/assets/js/ryu/html5.js" type="text/javascript"></script>
	<![endif]-->

	<?php wp_head(); ?>
	<link rel="stylesheet" type="text/css" media="screen" href="<?php echo get_stylesheet_directory_uri(); ?>/style.css?v=2" />
</head>
