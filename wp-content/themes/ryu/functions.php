...
function ryu_scripts() {
	...
	if ( has_nav_menu( 'primary' ) )
		wp_enqueue_script( 'ryu-navigation', get_template_directory_uri() . '/assets/js/ryu/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'ryu-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/ryu/skip-link-focus-fix.js', array(), '20130115', true );

	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) )
		wp_enqueue_script( 'comment-reply' );

	if ( is_singular() && wp_attachment_is_image() )
		wp_enqueue_script( 'ryu-keyboard-image-navigation', get_template_directory_uri() . '/assets/js/ryu/keyboard-image-navigation.js', array( 'jquery' ), '20120202' );

	wp_enqueue_script( 'ryu-theme', get_template_directory_uri() . '/assets/js/ryu/ryu.js', array( 'jquery' ), '20130319', true );
}
